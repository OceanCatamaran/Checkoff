...
class CLCalendar:
    ...
    def getDateRangeBetweenDates(self, y1, m1, d1, y2, m2, d2) -> list:
        ...
        while(True):
            #print("{0}/{1}/{2}".format(currentMonth, currentDay, currentYear))
            try:
                #print(currentMonth)
        ...
        #print("oDR: {0}".format(outDateRange))
        return outDateRange
    ...
    def _dateFormatter(val_1, val_2):
        ...
        if date_1[0] < 1 or 12 < date_1[0] : raise ValueError("val_1 invalid month")
        if date_1[1] < 1 or 31 < date_1[1] : raise ValueError("val_1 invalid day")
        ...
        if date_2[0] < 1 or 12 < date_2[0] : raise ValueError("val_2 invalid month")
        if date_2[1] < 1 or 31 < date_2[1] : raise ValueError("val_2 invalid day")

        #print("val_2 ok")

        if date_1[2] >= date_2[2] and date_1[1] >= date_2[1] and date_1[0] >= date_2[0]: raise ValueError("Beginning same as or equal to ending number.")
...
if __name__ == "__main__":
    ...
    print()
    print(cObj.getDateRangeBetweenDates(2023, 1, 1, 2025, 1, 1))
