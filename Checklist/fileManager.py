...
class FileManager:
    ...
    @classmethod
    def renameFile(self, grid, oldFileName, newFileName) -> None:
        #Takes an old file name to delete that file, and a new File name for
        #renamed C-Sheet.
        FileIO.writeDataTo(repr(grid), newFileName)
        FileIO.deleteFile(oldFileName)
