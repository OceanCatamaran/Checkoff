        ...
        def frameMaker(display = False):
            ...
            if display:
                ...
                if selection != "":
                    ...
                    #Line is commented to allow users to rename a selected C-Sheet when edditing it.
                    #Code for renaming C-Sheet is in the UpdateCSheet Callback.
                ...
                def updateCSheet():
                    ...
                    if (selection == fileName):
                        print("fileName is the same.")
                        FileManager.setFile(gObj, fileName)
                    else:
                        print("fileName has been changed.")
                        FileManager.renameFile(gObj, selection, fileName)
